...
public enum Message {
   ...
   NO_VALID_CHARACTER ("You haven't introduced a valid number. Please try again.\n"),
   NO_VALID_COLUMN ("Invalid position for token - That column doesn't exist!\n"),
   NO_SPACE_IN_COLUMN ("Invalid position for token - There is no more space in that column!\n"),
